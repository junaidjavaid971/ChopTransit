...
import app.com.choptransit.databinding.FragmentDriverSignUpBinding;
...
public class DriverSignupFragment extends Fragment {
    ...
    FragmentDriverSignUpBinding binding;
    AuthViewModel viewModel;
    OtpVerifiedCallback callback;

    public DriverSignupFragment() {
    }

    public DriverSignupFragment(OtpVerifiedCallback callback) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(
                inflater, R.layout.fragment_driver_sign_up, container, false);
    ...
    private void setObservers() {
        ...
        viewModel.verifyOtpLiveData.observe(getActivity(), loginResponse -> {
            if (loginResponse.getCode().equals("00")) {
                callback.onOtpVerified(viewModel.driverRegistrationModel.getPhoneNumber());
            } else {
                Commons.showToast(getActivity(), loginResponse.getDesc());
            }
        });
