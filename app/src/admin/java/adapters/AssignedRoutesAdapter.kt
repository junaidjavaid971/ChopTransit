...
class AssignedRoutesAdapter(var arrayList: ArrayList<AssignRouteData>, var context: Context) :
    ...
    fun filter(text: String) {
        ...
        if (text.isEmpty()) {
            ...
            for (assignedRoute in tempList!!) {
                if (assignedRoute.route.routeName.toLowerCase().contains(text)) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val listItem = layoutInflater.inflate(R.layout.layout_assigned_route_item, parent, false)
    ...
    private fun initTimeLineAttributes(holder: ViewHolder, route: RouteData) {
        ...
        holder.rvStops.apply {
            ...
            adapter = AssignedRouteTimelineAdapter(route.stops, attributes)
