package app.com.choptransit.app.com.choptransit.adapters
...
class RideHistoryAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvBusName.text = booking.assignedRoute.bus.busName
        holder.tvBusNumber.text = booking.assignedRoute.bus.busRegNo
        holder.tvStopNmae.text = booking.stopName
    }
