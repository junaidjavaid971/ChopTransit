...
import app.com.choptransit.utilities.ResourceUtils;
...
public class CreditCardNumberTextWatcher implements TextWatcher {
    ...
    public CreditCardNumberTextWatcher(EditText editText, TextView tvError) {
    ...
    private CreditCardType showDetectedCreditCardImage(String creditCardNumber) {
        ...
        if (type != null) {
            ...
            Drawable icon = ResourceUtils.getDrawableByName(this.editText.getContext(), "ic_credit_card");
            this.editText.setCompoundDrawablesWithIntrinsicBounds(icon, null, null, null);
        }
        return type;
    }
