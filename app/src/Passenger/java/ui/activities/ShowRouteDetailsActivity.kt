...
import adapters.BookRouteTimelineAdapter
...
import app.com.choptransit.databinding.ActivityShowRouteDetailsBinding
...
class ShowRouteDetailsActivity : AppCompatActivity() {
    lateinit var binding: ActivityShowRouteDetailsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_show_route_details)
        ...
        binding.bottomSheet.findViewById<TextView>(R.id.tvFare).text = "Fare: " + route.route.fare
    ...
    private fun initTimeLineAttributes(route: AssignRouteData) {
        ...
        val mLayoutManager =
            LinearLayoutManager(this@ShowRouteDetailsActivity, RecyclerView.VERTICAL, false)

        binding.bottomSheet.findViewById<RecyclerView>(R.id.rvStops).apply {
            layoutManager = mLayoutManager
            adapter = BookRouteTimelineAdapter(
                route,
                attributes,
                this@ShowRouteDetailsActivity
            )
